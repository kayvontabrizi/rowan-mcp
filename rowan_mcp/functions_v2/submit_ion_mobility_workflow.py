...
def submit_ion_mobility_workflow(
    initial_molecule: Annotated[
        str, "SMILES string of the molecule for ion mobility prediction"
    ],
    temperature: Annotated[int, "Temperature in Kelvin for CCS calculation"] = 300,
    protonate: Annotated[
        bool, "Whether to automatically protonate the molecule"
    ] = False,
    do_csearch: Annotated[
        bool, "Whether to perform conformational search before CCS calculation"
    ] = True,
    do_optimization: Annotated[
        bool, "Whether to optimize molecular geometry before CCS calculation"
    ] = True,
    name: Annotated[
